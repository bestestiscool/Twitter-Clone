...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.testuser = User.signup("testing", "testing@test.com", "password", image_url=None, bio="I am good looking", location= "Canada",header_image_url="http:google.com")
    ...
    def test_unauthorized_message_delete(self):
        ...
        u = User.signup(username="unauthorized-user1",
                        email="testtest2@test.com",
                        password="password",
                        image_url=None,
                        bio= "Hello, world!",
                        location= "Toronto",
                        header_image_url="http://example.com")
        u.id = 76543
