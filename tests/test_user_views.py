...
class UserViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u1 = User.signup(
        username="abc", email="test1@test.com",password= "password", image_url=None, bio="Great", location="Russia", header_image_url="http://")


        self.u1_id = 778

        self.u2 = User.signup("efg", "test2@test.com", "password", None,"Great", "Russia", "http://")

        self.u2_id = 884

        self.u3 = User.signup("hij", "test3@test.com", "password", None,"Great", "Russia", "http://")

        self.u4 = User.signup("testing", "test4@test.com", "password", None,"Great", "Russia", "http://")
...
# ----------------------------------------------------------------Below is more testing that needs to be refined
